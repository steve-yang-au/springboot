...
public class Redis2Tests{
    ...
    public void testValueObj() {
        ...
        valueOperations.set("player:1",person,60, TimeUnit.SECONDS); //60秒之后数据消失
        //根据key把数据取出来
        Person getBack = valueOperations.get("player:1");
    ...
    public void testSetOperation() {
        ...
        Set<Person> result = setOperations.members("playerset");
    ...
    public void HashOperations() {
        ...
        System.out.println(hashOperations.keys("hash:player"));
    }
    ...
    public void  ListOperations() {
        ...
        Person person = listOperations.leftPop("list:player");
        System.out.println(person); //curry对象
        System.out.println(listOperations.range("list:player", 0, -1));// get all data from the list
    }
}
